...
@testset "AI² example" begin
    ...
    @test isequivalent(forward(H, N, AI2Box()),
                       Hyperrectangle(; low=[0.0, 1.0], high=[3.0, 3.0]))
    # TODO
    @test isequivalent(forward(Z, N, AI2Zonotope()),
                       Zonotope([0.5, 2.0], [0.5 0.5 -0.5; 0.0 0.5 0.5]))
